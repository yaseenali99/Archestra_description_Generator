...
df_galaxy = pd.read_csv("..\data\\test_phase.csv")
...
#Grabs tagname for no good reason since this is the template
...
df_temp.to_csv("..\data\\test_phase_mod.csv",index=None)#,quoting=csv.QUOTE_NONE,quotechar='',  escapechar="\\")
